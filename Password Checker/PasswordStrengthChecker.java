...
public class PasswordStrengthChecker {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(" STRONG PASSWORD CHECKER DEVELOPED BY SITHARTHAN S");
        System.out.println();
        ...
        analyzepassword(password, length);
        checkStrength(length);
   
  
    }

    static void analyzepassword(String password,int length){
